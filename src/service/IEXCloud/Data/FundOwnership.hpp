...
class FundOwnership {
 ...
 public:
  ...
  void setReportedMarketValue(const std::string &reportedMarketValue) {
    reported_market_value = reportedMarketValue;
  }

  std::string reportedHolding() const { return reported_holding; }
  void setReportedHolding(const std::string &reportedHolding) {
  ...
  void setEntityProperName(const std::string &entityProperName) {
    entity_proper_name = entityProperName;
  }

  std::string adjustedMarketValue() const { return adjusted_market_value; }
  void setAdjustedMarketValue(const std::string &adjustedMarketValue) {
  ...
  void setAdjustedHoldings(const std::string &adjustedHoldings) {
